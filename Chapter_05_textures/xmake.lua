...
target("Prog5_1_texturedPyramid")
    set_kind("binary")
    add_files("Prog5_1_texturedPyramid/*.cpp")
    if is_os("windows") then
...
target("Prog5_1b_texturedPyramidMipmapAniso")
    set_kind("binary")
    add_files("Prog5_1b_texturedPyramidMipmapAniso/*.cpp")
