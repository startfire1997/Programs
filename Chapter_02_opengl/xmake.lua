...
target("Prog2_1_background")
    set_kind("binary")
    add_files("Prog2_1_background/*.cpp")
    if is_plat("windows") then
        add_packages("opengl", "glew", "glfw3", "soil2", "glm")
        add_links("shell32", "User32", "Gdi32", "msvcrt")
    end

target("Prog2_2_point")
    set_kind("binary")
    add_files("Prog2_2_point/*.cpp")
    if is_plat("windows") then
        add_packages("opengl", "glew", "glfw3", "soil2", "glm")
        add_links("shell32", "User32", "Gdi32", "msvcrt")
    end

target("Prog2_3_errorChecking")
    set_kind("binary")
    add_files("Prog2_3_errorChecking/*.cpp")
    if is_plat("windows") then
        add_packages("opengl", "glew", "glfw3", "soil2", "glm")
        add_links("shell32", "User32", "Gdi32", "msvcrt")
    end

target("Prog2_4_files")
    set_kind("binary")
    add_files("Prog2_4_files/*.cpp")
    if is_plat("windows") then
        add_packages("opengl", "glew", "glfw3", "soil2", "glm")
        add_links("shell32", "User32", "Gdi32", "msvcrt")
    end
...
target("Prog2_5_triangle")
    set_kind("binary")
    add_files("Prog2_5_triangle/*.cpp")
    if is_plat("windows") then
        add_packages("opengl", "glew", "glfw3", "soil2", "glm")
        add_links("shell32", "User32", "Gdi32", "msvcrt")
    end

target("Prog2_6_animation")
    set_kind("binary")
    add_files("Prog2_6_animation/*.cpp")
    if is_plat("windows") then
        add_packages("opengl", "glew", "glfw3", "soil2", "glm")
        add_links("shell32", "User32", "Gdi32", "msvcrt")
    end

target("Prog2_supplemental_queryingOpenGL")
    set_kind("binary")
    add_files("Prog2_supplemental_queryingOpenGL/*.cpp")
    if is_plat("windows") then
        add_packages("opengl", "glew", "glfw3", "soil2", "glm")
        add_links("shell32", "User32", "Gdi32", "msvcrt")
    end
